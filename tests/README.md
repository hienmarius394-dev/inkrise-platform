...
| `reseau-lent` | Ce que change une vraie 3G, **et un serveur qui ne répond pas** : une requête encore en attente à 20 s est traitée comme un échec (seuil calé sur les 12,3 s du pire cas mesuré), et les « Chargement… » qui ne finiront jamais cessent de mentir — avec la contre-épreuve qu'une 3G au bord de la couverture qui fonctionne n'alerte pas. Plus : aucune page ne précharge de police (mesuré, le préchargement retardait le premier affichage de 1,6 s en réclamant 70 Ko avant l'arrivée du HTML), `font-display: swap` conservé, et un envoi de planches interrompu garde l'œuvre en **brouillon** au lieu de la publier amputée — avec la contre-épreuve qu'un envoi réussi publie toujours normalement |
...
| `diagnostic` | `diagnostic.html` dit-elle la vérité ? Les six situations sont rejouées — serveur en veille, serveur injoignable, clé refusée, table refusée, téléphone hors ligne, tout va bien — et chacune doit produire **son** verdict. Une page de diagnostic qui se trompe est pire qu'aucune : elle envoie réparer ce qui n'est pas cassé |
